...
export function SettingsPage({ bgKey, onPresetChange, resetKey = 0, visible = true }: SettingsPageProps) {
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 24, cursor: 'pointer' }} onClick={popDetail}>
          ...
          >‹</span>
          <p style={{ color: '#fff', fontSize: 18, fontWeight: 700, margin: 0, letterSpacing: -0.3, pointerEvents: 'none' }}>首页背景</p>
        </div>
        <div style={{
          borderRadius: 14,
          background: 'linear-gradient(135deg, rgba(99,102,241,0.12) 0%, rgba(168,85,247,0.08) 100%)',
